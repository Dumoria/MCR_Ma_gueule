public class Tresorier implements Goblin
{

	Model model;

	public Tresorier(Model model, Emploi emploi, double salaire, Goblin collegue, Goblin superieur, Difficulte difficulte) { super(model, emploi, salaire, collegue, superieur, difficulte)
